...
using Project_Hexagonal_Astral_Islands.Models.AccountViewModels;
using Project_Hexagonal_Astral_Islands.Services;
using NHibernate;
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var user = new ApplicationUser { UserName = model.Email, Email = model.Email, my_map_id=map_id };
                //user.personal_map.GenerateNew();
                var result = await _userManager.CreateAsync(user, model.Password);
                if (result.Succeeded)
                {
                    _logger.LogInformation("User created a new account with password.");
                    //Console.WriteLine("Map generated for user:");
                    //Console.WriteLine(user.personal_map.GetMap().ToString());
